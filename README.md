...
- [x] Create a list of to-do actions
- [x] Delete to-do actions
- [x] Re-arrange to-do actions
...
Feel free to check the [issues page](https://github.com/dave-prog/Todo-List/issues).
